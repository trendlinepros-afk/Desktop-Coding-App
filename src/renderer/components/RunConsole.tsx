...
export function RunConsole(): JSX.Element {
  ...
  if (!project) {
    return (
      <div className="flex h-full items-center justify-center bg-surface p-8 text-center text-sm text-content-muted">
  ...
  return (
    <div className="flex h-full min-h-0 flex-col bg-surface">
      <div className="flex items-center gap-2 border-b border-border bg-surface px-3 py-2">
        ...
        <button
          className="rounded border border-border px-3 py-1 text-sm text-content hover:bg-surface-muted"
