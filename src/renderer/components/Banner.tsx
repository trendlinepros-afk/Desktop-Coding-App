...
/**
 * Top-of-app status banner. Shows transient errors/info pushed to the store,
 * plus a persistent warning when no models are available at all (Ollama down
 * and no valid cloud keys).
 */
export function Banner(): JSX.Element | null {
  ...
  return (
    <div className="flex flex-col">
      {noModels && (
        <div className="flex items-center justify-between bg-amber-500/15 px-4 py-2 text-sm text-amber-700 dark:text-amber-300">
          <span>
            No models available.{' '}
